...
`ErgoPaySigningRequest` or `ErgoPaySigningRequestUrl` data (see [Reference
Implementation](#reference-implementation) section). In the later case the Hot
...
The implementation of this EIP is based on a new data structure and
