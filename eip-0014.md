...
```scala
{
    ...
    val isValidInitialDepositing = {
        ...
        val productAB    = depositedA * depositedB
        val validDeposit = productAB * productAB == desiredShare // Deposits satisfy desired share
...
```scala
{
    val InitialLiquiditySharesLocked = 1000000000000000000L
    ...
    val supplyLP0 = InitialLiquiditySharesLocked - reservedLP0._2
    val supplyLP1 = InitialLiquiditySharesLocked - reservedLP1._2
    ...
    val isValidSwaption =
        if (deltaReservesA > 0)
            -deltaReservesB <= (reservesB0.toBigInt * deltaReservesA * 997) / (reservesA0.toBigInt * 1000)
        else
