...
|Minimum data points| **minDataPoints** | 4 | The minimum number of fresh data points needed to refresh pool box <br /> A data point is fresh if it has been posted in the last **e** blocks|
