...
* `CONTAINS(register, value)` returns true if certain register contains given value. If *register* argument is missed, R1 will be scanned
...
```json
{
    ...
    "trackingRule" : {
        "predicate": "and",
        "args":[
            {"predicate": "contains", "bytes": "0e240008cd029f2230dbe53f6b84d8a884a3407c3dffe43daf8037445441be7cdcd261feeaa4"},
