        ...
        OUTPUTS.exists { (box: Box) =>
            ...
            val isFairPrice =
                if (poolAssetX._1 == QuoteId)
                    quoteAmount >= (poolAssetX._2.toBigInt * baseAmount * 997) / (poolAssetY._2.toBigInt * 1000 + baseAmount * 997)
                else
                    quoteAmount >= (poolAssetY._2.toBigInt * baseAmount * 997) / (poolAssetX._2.toBigInt * 1000 + baseAmount * 997)
