...
## Signing Pseudocode implementation

```ts
const networkCode = 0x0; // 0x0 = mainnet, 0x10 = testnet
const invalidationByte = 0x0;

const bytes = concat(invalidationByte, networkCode, blake2b256(dataBytes));
