...
```scala
{
    ...
    val validPoolConfig    = pool.R9[Long].get == poolFeeConfig 
...
tokens[2] | Asset X
tokens[3] | Asset Y
R9[Long]  | Fee multiplier numerator (e.g. 0.003% fee -> 997 fee_num)
...
```scala
{
    ...
    val feeNum1 = successor.R9[Long].get
...
#### Generic depositing proxy-contract
