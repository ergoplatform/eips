...
Examples:
* `ergopayurl://sigmausd.io/signingRequest/2001-16b8-66c4-b800-6e52-8ce4` will make the wallet app request
`https://sigmausd.io/signingRequest/2001-16b8-66c4-b800-6e52-8ce4`
* `ergopayurl://192.168.0.1/html` will make the wallet app request
`http://192.168.0.1/html`
* `ergopayurl://auctionhouse.org/bid/#P2PK_ADDRESS#` will make the wallet app request `ergopayurl://auctionhouse.org/bid/3Wx7Z8FywaL4ofunDCV1NaTJX5CpjTubMrjpCkEhnNBAgJLGfRcD`
